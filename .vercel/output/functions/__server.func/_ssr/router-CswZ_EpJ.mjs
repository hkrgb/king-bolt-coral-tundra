...
import { S as requireWorkshopFromRequest, T as serveMediaResponse, c as UnauthorizedError, r as ForbiddenError, u as auth, w as saveMediaFile, y as isMediaFilename } from "./media.server-n7-WniYt.mjs";
import { n as TriangleAlert } from "../_libs/lucide-react.mjs";
import { t as Toaster } from "../_libs/sonner.mjs";
import { t as QueryClient } from "../_libs/tanstack__query-core.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/router-CswZ_EpJ.js
...
var styles_default = "/assets/styles-DZcrHUbD.css";
var APP_NAME = "RGB Workshop";
...
var $$splitComponentImporter$2 = () => import("./routes-BX6SfB5s.mjs");
var Route$6 = createFileRoute("/")({ component: lazyRouteComponent($$splitComponentImporter$2, "component") });
var Route$5 = createFileRoute("/$filename")({ server: { handlers: {
...
var $$splitComponentImporter$1 = () => import("./login-DRiAddPc.mjs");
var Route$4 = createFileRoute("/login")({ component: lazyRouteComponent($$splitComponentImporter$1, "component") });
var Route$3 = createFileRoute("/api/upload")({ server: { handlers: { POST: async ({ request }) => {
	try {
		...
		return new Response(message, { status: Number.isFinite(status) && status >= 400 ? status : 500 });
	}
} } } });
var $$splitComponentImporter = () => import("../_slug-FpEzDiHd.mjs");
var Route$2 = createFileRoute("/f/$slug")({ component: lazyRouteComponent($$splitComponentImporter, "component") });
var Route$1 = createFileRoute("/api/auth/$")({ server: { handlers: {
	GET: ({ request }) => auth.handler(request),
	POST: ({ request }) => auth.handler(request)
} } });
var Route = createFileRoute("/api/media/$slug")({ server: { handlers: {
...
var rootRouteChildren = {
	...
	ApiUploadRoute: Route$3.update({
		id: "/api/upload",
		path: "/api/upload",
		getParentRoute: () => Route$7
	}),
	FSlugRoute: Route$2.update({
		id: "/f/$slug",
		path: "/f/$slug",
		getParentRoute: () => Route$7
	}),
	...
	ApiMediaSlugRoute: Route.update({
		id: "/api/media/$slug",
		path: "/api/media/$slug",
		getParentRoute: () => Route$7
	})
