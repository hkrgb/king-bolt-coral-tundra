...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-CeEOu8R6.mjs");
...
var manifest = {
	"08e6670725f4e7c1d69e653f15ad23ef81d7d1b2e26555d85ed6cc58ee9dc304": {
		functionName: "fetchMediaMeta_createServerFn_handler",
		importer: () => import("./media.functions-DY5E7szM.mjs")
	},
	"3945f671611c6e2a9708aa2bfa127f322e3827719e5771bfeec47c4c65a82285": {
		functionName: "removeMedia_createServerFn_handler",
		importer: () => import("./media.functions-DY5E7szM.mjs")
	},
	"60ba8bb85d6974f1ed368785b9ef06d7d4cdcffc342ddc0eba47468667639521": {
		functionName: "connectGithub_createServerFn_handler",
		importer: () => import("./media.functions-DY5E7szM.mjs")
	},
	"661efbc0d6c38d5aeea5dafce9666da6c8b47e7c864395b679b04319d00c2546": {
		functionName: "getGithubStatus_createServerFn_handler",
		importer: () => import("./media.functions-DY5E7szM.mjs")
	},
	"f47ce756bd1f13fe63c26f0b8f37083e163382b8b3bb9364773cb277258896dc": {
		functionName: "listMyMedia_createServerFn_handler",
		importer: () => import("./media.functions-DY5E7szM.mjs")
	}
};
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-CswZ_EpJ.mjs").then((n) => n.t),
